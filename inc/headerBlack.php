...
<head>
    ...
    <link rel="shortcut icon" href="images/duran.png">
    ...
    <div class="container"> 
        ...
        <ul class="nav hidden-xs menu-item menu-item" style="margin-top:110px;z-index: 5;background-color:rgba(0, 0, 0, 0.20);border-color:rgba(0, 0, 0, 0.50);">                  
            ...
            <li class="level0 parent drop-menu"><a style="color: #000" href="productos.php?cat=3" class="level-top"><span>Aperitivos</span></a>
              ...
              <li class="level0 parent drop-menu px3"><a style="color: #000" href="productos.php?cat=4" class="level-top"><span>Gin   </span></a>              
              <ul class="level1" style="display: none;">
            ...
            <li class="level0 parent drop-menu px3"><a style="color: #000" href="productos.php?cat=5" class="level-top"><span>Destilados</span></a>
              <ul class="level1" style="display: none;">
            ...
            <li class="level0 parent drop-menu px3"><a style="color: #000" href="productos.php?cat=1" class="level-top"><span>Sin Alcohol</span></a>
              <ul class="level1" style="display: none;">
            ...
            <li class="level0 parent drop-menu px3"><a style="color: #000" href="productos.php?cat=10" class="level-top"><span>Regaleria</span></a>
              <ul class="level1" style="display: none;">
                <li class="level1 first"> <a href="productos.php?cat=37"> <span>Estucheria</span> </a> </li>
              </ul></li>
            
            <li class="level0 parent drop-menu px3"><a style="color: #000" href="productos.php?cat=11" class="level-top"><span>Placeres</span></a>
              <ul class="level1" style="display: none;">
