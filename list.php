...
<section class="main-container col2-left-layout bounceInUp animated">
  <div class="container">
    ...
    <div class="row">
	  ...
	  <div class="category-image"><img title="Sofas " alt="Sofas " src="images/category-banner.jpg"> </div>
        <article class="col-main">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#/30-flat-panel-tft-lcd-cinema-hd-monitor.html" title="30&quot; Flat-Panel HD Monitor"> <img class="small-image" src="products-images/product.jpg" alt="30&quot; Flat-Panel HD Monitor"> </a> </div>
            <div class="product-shop">
          ...
          <li class="item even">
            <div class="product-image"> <a href="#/19-widescreen-flat-panel-lcd-monitor.html" title="19&quot; Widescreen LCD Monitor"> <img class="small-image" src="products-images/product.jpg" alt="19&quot; Widescreen LCD Monitor"> </a> </div>
            <div class="product-shop">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#/250gb-5400rpm.html" title="Seagate 250GB HD "> <img class="small-image" src="products-images/product.jpg" alt="Seagate 250GB HD "> </a> </div>
            <div class="product-shop">
          ...
          <li class="item even">
            <div class="product-image"> <a href="#/500gb-5400rpm.html" title="Seagate 500GB HD"> <img class="small-image" src="products-images/product.jpg" alt="Seagate 500GB HD"> </a> </div>
            <div class="product-shop">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#" title="Intel Core 2 Extreme QX9775"> <img class="small-image" src="products-images/product.jpg" alt="Intel Core 2 Extreme QX9775"> </a> </div>
            <div class="product-shop">
          ...
          <li class="item even">
            <div class="product-image"> <a href="#/24-widescreen-flat-panel-lcd-monitor.html" title="24&quot; Widescreen LCD Monitor"> <img class="small-image" src="products-images/product.jpg" alt="24&quot; Widescreen LCD Monitor"> </a> </div>
            <div class="product-shop">
          ...
          <li class="item odd">
            <div class="product-image"> <a href="#/microsoft-wireless-optical-mouse-5004.html" title="Logitech Optical Trackman"> <img class="small-image" src="products-images/product.jpg" alt="Logitech Optical Trackman"> </a> </div>
            <div class="product-shop">
          ...
          <li class="item last even">
            <div class="product-image"> <a href="#/logitech-dinovo-edge-keyboard.html" title="Logitech diNovo Edge Keyboard"> <img class="small-image" src="products-images/product.jpg" alt="Logitech diNovo Edge Keyboard"> </a> </div>
            <div class="product-shop">
